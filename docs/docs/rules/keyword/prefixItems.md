...
|---------|------|----------|
| openai.so.2026-04-30 | `OAI-K-prefixItems` | Warn |
| anthropic.so.2026-04-30 | `ANT-K-prefixItems` | Forbid |

## Description

Flag usage of the 'prefixItems' keyword according to the active provider profile.
