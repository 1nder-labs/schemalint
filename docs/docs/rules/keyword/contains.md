...
|---------|------|----------|
| openai.so.2026-04-30 | `OAI-K-contains` | Forbid |
| anthropic.so.2026-04-30 | `ANT-K-contains` | Forbid |

## Description

Flag usage of the 'contains' keyword according to the active provider profile.
