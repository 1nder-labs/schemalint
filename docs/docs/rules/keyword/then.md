...
|---------|------|----------|
| openai.so.2026-04-30 | `OAI-K-then` | Forbid |
| anthropic.so.2026-04-30 | `ANT-K-then` | Forbid |

## Description

Flag usage of the 'then' keyword according to the active provider profile.
